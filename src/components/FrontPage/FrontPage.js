        ...
        <div className="w-10/12">
          <div class=" p-6 bg-white border border-gray-200 rounded-lg shadow  ">
            ...
            <div className="flex items-center mt-8 ">
              <button
                type="button"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 me-2 mb-2 h-12 w-5/6 md:w-2/3 lg:w-1/3 focus:outline-none " onClick={handleNavigate}
              >
